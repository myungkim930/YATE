...
def load_config():
    ...
    # Directories
    config["fasttext_dir"] = "/storage/store3/work/mkim/gitlab/cc.en.300.bin"
    config[
        "ken_embed_dir"
    ] = "/storage/store3/work/jstojano/gitlab/alexis_cvetkov/KEN/experiments/embedding_visualization/emb_mure_yago3_2022_full.parquet"
    config["data_kg_dir"] = "/storage/store3/work/mkim/gitlab/YATE/data/kg_data/"
    config[
        "data_eval_ds_dir"
    ] = "/storage/store3/work/mkim/gitlab/YATE/data/eval_ds_data/"
    config[
        "data_eval_jl_dir"
    ] = "/storage/store3/work/mkim/gitlab/YATE/data/eval_jl_data/"
    config[
        "data_eval_kg_dir"
    ] = "/storage/store3/work/mkim/gitlab/YATE/data/eval_kg_data/"
    ...
    config["histgb_hparam"] = {
        ...
        "min_samples_leaf": scope.int(hp.qnormal("min_samples_leaf", 20, 2, 1)),
        "max_leaf_nodes": scope.int(hp.qnormal("max_leaf_nodes", 31, 5, 1)),
    }
    config["gb_hparam"] = {
        "learning_rate": hp.lognormal("learning_rate", np.log(0.01), np.log(10.0)),
