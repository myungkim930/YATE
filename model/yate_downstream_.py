"""
YATE-GNN model with defined layers for regression and classification.

"""

import torch
import torch.nn as nn
from .yate_block import YATE_Base, YATE_Contrast


# YATE - Finetune block for regression
class YATE_GNNModel_Reg(nn.Module):
    def __init__(
        self,
        input_dim_x: int,
        input_dim_e: int,
        ...
        **block_args
        ...
        super(YATE_GNNModel_Reg, self).__init__()
        ...
        self.ft_similarity = YATE_Contrast()
    ...
    def forward(self, input):
        ...
        similarity = self.ft_similarity(x)
...
class YATE_GNNModel_Cls(nn.Module):
    def __init__(
        self,
        input_dim_x: int,
        input_dim_e: int,
        ...
        **block_args
        ...
        super(YATE_GNNModel_Cls, self).__init__()
