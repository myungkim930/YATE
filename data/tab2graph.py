"""
Function for transforming tables (DFs) into graphs
...
class Tab2gr:
    def __init__(self, data_name: str):
        ...
        super(Tab2gr, self).__init__()

        data_dir = os.getcwd() + "/data/data_col/" + data_name + ".parquet"
    ...
    def make_graph(
        ...
        edge_index = triplet[[head_ent_col, "value"]]
        ...
        if save:
            ...
            save_dir = os.getcwd() + "/data/data_col/" + self.data_name + ".pickle"
